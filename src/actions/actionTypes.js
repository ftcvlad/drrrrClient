...
export const LEAVE_ROOM_TABLES_SUCCEED = 'LEAVE_ROOM_TABLES_SUCCEED';
//create game
...
export const UPDATE_TIME_LEFT_SUCCEED = "UPDATE_TIME_LEFT_SUCCEED";
export const DROP_OPPONENT_SUCCEED = "DROP_OPPONENT_SUCCEED";